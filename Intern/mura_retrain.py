...
#     plt.title('ROC for digit=%d class' % 2)
    ...
    plt.savefig("ROC_curve"+str(expt)+".png")
    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            if (phase == 'val'):
                ...
                print(metrics.confusion_matrix(val_ac, val_pred))
            ...
            if (epoch_acc > old_acc):
                ...
                old_acc = epoch_acc
                file = 'model_retrained'+str(expt)+'.pth'
...
checkpoint = torch.load("model_syntheticsyn_wasser1.pth")
...
optimizer = adabound.AdaBound(model.parameters(), lr=0.00005, final_lr=0.0005)
